# fuzzy-mamdani-batik-production
Analysis of the accuracy level of the Fuzzy Mamdani method to determine the production quantity of batik sarongs using Python

## Description
This repository contains a project that analyzes the **accuracy of the Fuzzy Mamdani method** in determining the optimal production quantity of batik sarongs.  
...
## Objectives
- To determine batik sarong production quantity using the Fuzzy Mamdani method  
...
2. Inference using the Mamdani method  
...
### 1. Open the Notebook
- Open the file `fuzzy-mamdani-batik-production.ipynb` in this GitHub repository
- Click **Open in Colab**
...
The system will calculate production quantity using the Fuzzy Mamdani method
...
The results show that the Fuzzy Mamdani method is able to generate production quantity estimates that are close to actual data, indicating that this method is suitable as a decision support tool for batik sarong production planning.
